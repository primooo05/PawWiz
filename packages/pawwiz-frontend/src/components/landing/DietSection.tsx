...
export default function DietSection({}: DietSectionProps) {
    ...
    return (
      <section id="diet" className="w-full min-h-screen flex items-center justify-center border-b border-slate-100 relative bg-gradient-to-br from-amber-50/15 via-white  to-slate-50/40">
        ...
        <div className="max-w-7xl w-full mx-auto px-8 md:px-16 py-20 grid md:grid-cols-2 gap-32 lg:gap-40 items-center">
  ...
  transition-all hover:-translate-y-0.5 flex items-center gap-2"
          ...
          <div className="relative w-full max-w-sm mx-auto transform rotate-1 md:-rotate-1 md:translate-y-8 z-20 transition-all duration-500 hover:rotate-0
  hover:scale-[1.02]">
  ...
  transform="rotate(198, 280, 150)"
                ...
                <g transform="translate(262, 130) scale(1.5)" fill="#1f2937" className="group-hover:fill-slate-600 group-hover:scale-110 transition-all duration-300    
  origin-center">
