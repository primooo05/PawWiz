import { useDietPlanner } from '../../../hooks/features/useDietPlanner';
        ...
        <div className="overflow-y-auto flex-1 p-6 md:p-8 pr-4 md:pr-6">
          ...
          <div className="mb-6">
            <div className="flex items-center gap-2 mb-3">
              <span className="w-1.5 h-1.5 bg-[#30c290] rotate-45 flex-shrink-0" />
              <span className="text-[10px] font-black tracking-[0.25em] text-[#30c290] uppercase">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center text-xs text-slate-500 font-bold uppercase tracking-wider">
                ...
                <div className="flex items-center gap-2">
                  <span className="font-extrabold text-[#30c290]">
                    {isKg 
                  ...
                  <div className="bg-slate-100 p-0.5 rounded-lg flex items-center border border-slate-200/50">
                    <button
                      ...
                      className={`px-1.5 py-0.5 rounded text-[9px] font-black transition-all ${isKg ? 'bg-[#30c290] text-white' : 'text-slate-500 hover:text-slate-800'}`}
                    >
                      KG
                    </button>
                    <button
              ...
              <input
                ...
                className="w-full h-2 bg-slate-100 rounded-lg appearance-none cursor-pointer accent-[#30c290]"
              />
            </div>
            ...
            <div className="space-y-3">
              <div className="flex justify-between text-xs text-slate-500 font-bold uppercase tracking-wider">
                <span>Age:</span>
                <span className="font-extrabold text-[#30c290]">{form.values.age} years</span>
              </div>
              <input
                type="range"
                min="1"
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 mt-2">
                ...
                <input
                  ...
                  className="w-full text-xs font-semibold px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:outline-none focus:border-[#30c290] focus:bg-white text-slate-700 placeholder-slate-400 transition-all"
                />
              </div>
            </div>
            ...
            <button
              ...
              className={`w-full font-extrabold py-4 rounded-xl text-xs uppercase tracking-wider transition-colors shadow-sm cursor-pointer ${
                !form.isValid 
                  ...
                  : 'bg-[#30c290] hover:bg-[#259b90] text-white'
              }`}
            >
            ...
            <div className="mt-6 relative overflow-hidden rounded-2xl">
              ...
              <div className="filter blur-sm pointer-events-none select-none opacity-20 space-y-4 bg-slate-950 text-slate-100 p-5 rounded-2xl border border-slate-850/80 text-[11px]">
                <div className="flex items-center justify-between border-b border-slate-900 pb-2 text-xs font-black">
                  ...
                  <span className="text-[#30c290] font-black">{dietPlan.dailyCalories} Kcal/day</span>
                </div>
